...
/* SVT botones min y max en dialogs*/
//        var div = $("<div>")
//        var mini = $("<div>")
//        var maxi = $("<div>")
//        mini.css({width:15,height:20,float:"right",cursor:"pointer"}).addClass("ui-icon-minus").addClass("ui-icon").addClass("ui-corner-all").attr("role", "button")
//        maxi.css({width:20,height:20,float:"right",marginRight:5,cursor:"pointer"}).addClass("ui-icon ui-icon-newwin").addClass("ui-corner-all").attr("role", "button")
//        mini.click(
//            function (a) {
//                var w = 0;
//                var h = 0;
//                var cook = getCookie("tam_"+b.uiDialog.find(".ui-dialog-content").attr("id"))
//                if(!cook){
//                    var exdate=new Date();
//                    exdate.setDate(exdate.getDate() + 10);
//                    var c_value= ""+ b.uiDialog.width()+"&"+ b.uiDialog.height()+"; expires="+exdate.toUTCString();
//                    document.cookie="tam_" +b.uiDialog.find(".ui-dialog-content").attr("id")+ "=" + c_value;
//                }else{
//                    var ar = cook.split("&")
//                    w=ar[0]*1
//                    h=ar[1]*1
//
//                    if(Math.round(b.uiDialog.width(),2)!=200){
//                        var exdate=new Date();
//                        exdate.setDate(exdate.getDate() + 10);
//                        var c_value= ""+ b.uiDialog.width()+"&"+ b.uiDialog.height()+"; expires="+exdate.toUTCString();
//                        document.cookie="tam_" +b.uiDialog.find(".ui-dialog-content").attr("id")+ "=" + c_value;
...
//                }
////
//                if(Math.round(w,2)!=Math.round(b.uiDialog.width(),2)){
//
//                    b.uiDialog.width(w);
//                    b.uiDialog.height(h);
//                    b.uiDialog.find(".ui-dialog-content").show("slide")
//                }else{
//
//                    b.uiDialog.width(200);
//                    b.uiDialog.height(50);
//                    b.uiDialog.find(".ui-dialog-content").hide("slide")
//                }
//
//
//
...
//                    w=ar[0]*1
//                    h=ar[1]*1
//                    if(Math.round(b.uiDialog.width(),2)!=(mw-50) && Math.round(b.uiDialog.width(),2)!=200){
//
//                        var exdate=new Date();
//                        exdate.setDate(exdate.getDate() + 10);
//                        var c_value= ""+ b.uiDialog.width()+"&"+ b.uiDialog.height()+"; expires="+exdate.toUTCString();
...
//                if(Math.round(w,2)!=Math.round(b.uiDialog.width(),2)){
//
//                    var cook2 = getCookie("pos_"+b.uiDialog.find(".ui-dialog-content").attr("id"))
//                    var ar = cook.split("&")
//                    var t=ar[0]*1
//                    var l=ar[1]*1
//                    b.uiDialog.width(w);
//                    b.uiDialog.height(h);
//                    b.uiDialog.animate({top:t,left:l})
////                    b.uiDialog.find(".ui-dialog-content").show("slide")
//                }else{
////                    console.log("position")
////                    console.log(b.uiDialog.option("position"))
////                    var exdate=new Date();
////                    exdate.setDate(exdate.getDate() + 10);
////                    var c_value= ""+ b.uiDialog.top()+"&"+ b.uiDialog.left()+"; expires="+exdate.toUTCString();
////                    document.cookie="pos_" +b.uiDialog.find(".ui-dialog-content").attr("id")+ "=" + c_value;
//
//                    b.uiDialog.width(mw-50);
//                    b.uiDialog.height(mh-220);
//                    b.uiDialog.animate({top:20,left:20})
////                    b.uiDialog.find(".ui-dialog-content").hide("slide")
//                }
//
//
...
//        div.append(mini)
//        div.append(maxi)
//        div.css({width:100,height:20,float:"right",marginRight:15,paddingTop:5})
//        div.addClass("botoncitos").appendTo(i)
