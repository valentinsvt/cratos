...
<g:form name="procesoForm" action="save" method="post" class="frmProceso">
    <div class="container entero ui-widget-content ui-corner-all">
        ...
        <div id="contenido" style="width: 900px;padding-left: 30px;">
            <div class="etiqueta">Gestor:</div> <g:select class="ui-corner-all" name="gestor.id" from="${cratos.Gestor.list()}" label="Proceso tipo: " value="${proceso?.gestor?.id}" optionKey="id" optionValue="nombre"></g:select>
            <br>
