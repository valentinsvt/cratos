        ...
        <g:form name="sriForm">
            <div class="container entero ui-widget-content ui-corner-all">
                ...
                <div class="span-28" style="margin-left: 40px; margin-top: 10px; margin-bottom: 15px">
                    <label>Año</label><g:select name="anioSri" from="${anios}"/>
                    <label>Período</label><g:select name="mesSri" from="${periodos}"/>
            ...
            <div class="span-28" style="margin-left: 40px; margin-top: 10px; margin-bottom: 15px">
                ...
                <g:select name="sustento" from="${sustento?.descripcion}" style="width: 550px"/>
            </div>
                ...
                <div class="span-28" style="margin-left: 40px; margin-top: 10px; margin-bottom: 15px">
                    ...
                    <g:textField name="tipoOdentificacion" value="${proceso?.proveedor?.tipoIdentificacion?.descripcion}" style="width: 150px"/>
                ...
                <div class="span-28" style="margin-left: 40px; margin-top: 10px; margin-bottom: 3px">
                    ...
                    <g:textField name="noObjetoIva" style="margin-left: 5px; margin-right: 150px" value="${proceso?.baseImponibleNoIva}"/>
                    <label>ICE</label><g:textField name="ice"  value="${proceso?.iceGenerado}"/>
                    <g:select name="porcentajeIce" from="${porIce?.retencion}" style="width: 60px" noSelection="['-1':'0']"/>
                    <g:textField name="valorRetenidoIce"/>
                </div>

                <div class="span-28" style="margin-left: 40px; margin-top: 3px; margin-bottom: 3px">
                    <label>Base Imponible IVA 0%</label>
                    <g:textField name="biIva0" style="margin-left: 70px; margin-right: 85px" value="${proceso?.baseImponibleIva0}"/>
                    <label>IVA(1) Bienes</label>
                    <g:textField name="bienes" value="${proceso?.retencionIvaBienes}"/>
                    <g:select name="porcentajeIvaBienes" from="${porBns?.retencion}" style="width: 60px" noSelection="['-1': '0']"/>
                    <g:textField name="valorRetenidoBienes"/>
                </div>

                <div class="span-28" style="margin-left: 40px; margin-top: 3px; margin-bottom: 3px">
                    <label>Base Imponible IVA 12%</label>
                    <g:textField name="biIva12" style="margin-left: 60px; margin-right: 25px" value="${proceso?.baseImponibleIva}"/>
                    <label>IVA(2) Servicios y 100%</label>
                    <g:textField name="servicios" value="${proceso?.retencionIvaServicios}"/>
                    <g:select name="porcentajeServicios" from="${porSrv?.retencion}" style="width: 60px" noSelection="['-1': '0']"/>
                    <g:textField name="valorRetenidoServicios"/>
                </div>
            ...
            <fieldset>
            <g:checkBox name="sinRetencion"/> <label> No tiene comprobante de Retención</label>
            </fieldset>
            </div>



            <div class="span-28" style="margin-left: 40px; margin-top: 10px; margin-bottom: 10px; margin-right: 25px">
                <fieldset>
            ...
            <div class="span-28" style="margin-left: 40px; margin-top: 10px; margin-bottom: 15px">
                ...
                <div class="span-28" style="margin-left: 40px; margin-top: 5px; margin-bottom: 15px">
                    <label>Concepto de la Retención del IR</label><g:select name="retencionIR" from="${cratos.ConceptoRetencionImpuestoRenta?.list()}" optionKey="id" optionValue="descripcion" style="width: 250px"/>
