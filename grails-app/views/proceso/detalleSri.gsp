...
<div class="span-28" style="margin-left: 40px; margin-top: 10px; margin-bottom: 15px">
    <label>Pago Local o Exterior</label><g:select class="ui-corner-all" name="pago" from="${['LOCAL', 'EXTERIOR']}" style="margin-left: 30px"/>
...
<div class="span-28 exterior" style="margin-left: 40px; margin-right: 30px; margin-top: 10px; margin-bottom: 15px" hidden="hidden">
    ...
    <fieldset>
        ...
        <div style="margin-top: 20px">
            <label style="margin-right: 30px">Aplica convenio de doble tributación?</label><g:radioGroup class="convenio" labels="['SI', 'NO']" values="['SI', 'NO']" name="convenio" value="">${it?.label} ${it?.radio}</g:radioGroup>
        </div>

        <div style="margin-top: 20px">
            <label style="margin-right: 30px">Pago sujeto a retención en aplicación de la norma legal</label><g:radioGroup class="norma" labels="['SI', 'NO']" values="['SI', 'NO']" name="norma" value="">${it?.label} ${it?.radio}</g:radioGroup>
        </div>
    </fieldset>
...
<div class="span-28" style="margin-left: 40px; margin-top: 5px; margin-bottom: 35px">
    ...
    <div class="dos">
        <g:select class="ui-corner-all  " name="conceptoRetencionImpuestoRenta" from="${cratos.ConceptoRetencionImpuestoRenta?.list()}" optionKey="id" optionValue="descripcion"/>
    </div>
