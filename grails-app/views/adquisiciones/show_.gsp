                        ...
                        <tbody id="tbItems">
                            <g:each in="${cratos.DetalleAdquisicion.findAllByAdquisiciones(adquisicionesInstance)}" var="item">
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        %{--${item.cantidad}--}%
                                        <g:formatNumber number="${item.cantidad}" minFractionDigits="2" maxFractionDigits="2"/>
                                    </td>
                                    <td style="text-align: right">${item.precioUnitario}</td>
                                    <td style="text-align: right">
                                        %{--${item.iva}--}%
                                        <g:formatNumber number="${item.iva}" minFractionDigits="2" maxFractionDigits="2"/>
                                    </td>
                                    <td style="text-align: right">
                                        %{--${item.ice}--}%
                                        <g:formatNumber number="${item.ice}" minFractionDigits="2" maxFractionDigits="2"/>
                                    </td>
                                    <td style="text-align: right">
                                        <g:set var="total" value="${total.toDouble() + item.subtotal}"/>
                                        <g:set var="iva" value="${iva.toDouble() + item.iva}"/>
