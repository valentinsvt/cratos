...
<html>
    <head>
        ...
        <title>Crear Sesn</title>
    </head>

    <body>
        <a href="#create-sesn" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>

        <div id="create-sesn" class="content scaffold-create" role="main">
