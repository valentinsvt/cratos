                ...
                <div class="contenedor">
                    <fieldset style="margin: 10px;">
                        ...
                        <div class="span-20">
                            ...
                            <div class="span-6">
                                <g:select from="${cratos.CentroCosto.findAllByEmpresa(session.empresa, [sort: 'nombre'])}" name="centroCosto.id" class="required span-6 ui-widget-content ui-corner-all"
