...
<a href="#" class="tbbtn btn" id="editarGestor" style="margin: 20px;margin-left: 80px;">
    Editar
</a>
...
<div style="width: 700px;height: 30px;margin-left: 80px;"><b>Estado: </b>${(gestor.estado=='A')?'Activo':'Inactivo'}</div>
<div style="width: 700px;height: 30px;margin-left: 80px;"><b>Observaciones: </b>${gestor?.observaciones}</div>
...
//
//    });
    $("#editarGestor").click(function(){
            location.href="${g.createLink(action:'nuevoGestor',id:gestor.id)}"
